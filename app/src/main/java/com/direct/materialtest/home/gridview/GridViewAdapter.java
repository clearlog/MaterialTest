package com.direct.materialtest.home.gridview;
...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder vh = null;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.home_class_item, parent, false);
            vh = new ViewHolder();
            vh.tv = (TextView) convertView.findViewById(R.id.class_name);
            vh.iv = (CircleImageView) convertView.findViewById(R.id.class_img);
