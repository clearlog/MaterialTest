package com.direct.materialtest.music.service;
...
import com.direct.materialtest.MusicActivity;
...
//                curposition = (curposition) % musiclist.size();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent != null){
            ...
            String name = "正在播放: "+ url.substring(url.lastIndexOf("/") + 1 , url.lastIndexOf("."));
            Log.i(TAG,name);
//        //开启前台service
            Notification notification = null;
            if (Build.VERSION.SDK_INT < 16) {
                notification = new Notification.Builder(this)
                        .setContentTitle("咪咪音乐").setContentText(name)
                        .setSmallIcon(R.drawable.head_default).getNotification();
            } else {
                Notification.Builder builder = new Notification.Builder(this);
                PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                        new Intent(this, MusicActivity.class), 0);
                builder.setContentIntent(contentIntent);
                builder.setSmallIcon(R.drawable.head_default);
//        builder.setTicker("Foreground Service Start");
                builder.setContentTitle("咪咪音乐");
